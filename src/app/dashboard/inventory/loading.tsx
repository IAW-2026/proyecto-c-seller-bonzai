  ...
  return (
    <div style={{ width: "min(100%, 1200px)", margin: "0 auto" }}>
      <header style={{ marginBottom: "2.5rem", borderLeft: "2px solid #1B3D2F", paddingLeft: "2rem" }}>
        <Skeleton height="2.5rem" width="240px" />
        <div style={{ marginTop: "0.5rem" }}><Skeleton height="0.9rem" width="180px" /></div>
      </header>
      ...
      {Array.from({ length: 5 }).map((_, i) => (
        <div key={i} style={{ display: "flex", gap: "1rem", alignItems: "center", borderBottom: "1px solid #e8ece9", padding: "1rem 0" }}>
          <Skeleton width="3rem" height="3rem" />
          <div style={{ flex: 1 }}><Skeleton height="1rem" width="40%" /></div>
